...
- Qual a quantidade ('n') de ações/eventos PDC implementados em 2013 e em 2022? Houve incremento quantitativo nesse expediente?
- Quais as destinações (continentes) receberam  maior quantidade ('n') de ações/eventos PDC em 2013 e 2022?
- Quais os domínios culturais predominantes nas ações/eventos PDC em 2013 e 2022? 
- Qual a proporcionalidade de indicadores indentitários de gênero e raça nos conteúdos artístico-culturais funcionalizados pelos PDC em 2013 e 2022?
...
- Em termos da variável (1) **número de projetos**: houve um incremento significativo de X% no 'n' de ações/eventos PDC 2022 em relação ao 'n' de ações/eventos PDC 2013;
